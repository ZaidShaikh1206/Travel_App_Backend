...
const { createWishlistHandler, deleteWishlistHandler, getWishlistHandler } =
  wishlistController;
// const createWishlistHandler = require("../controllers/wishlistController");
// const deleteWishlistHandler = require("../controllers/wishlistController");
// const getWishlistHandler = require("../controllers/wishlistController");
